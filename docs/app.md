...
It includes a browser JavaScript port of the BINI converter and does not require the ASP.NET app or any backend. Publish `docs` as the GitHub Pages root and open `/portal/`.
