(function () {
  ...
  const strings = {
    en: {
      ...
      'demo.text': 'The demo shows how a Freelancer BINI file becomes readable INI text in the browser, ready for inspection, editing, and repacking.',
    ...
    ru: {
      ...
      'demo.text': 'Демонстрация показывает, как BINI файл Freelancer становится читаемым INI прямо в браузере: его можно изучить, отредактировать и собрать обратно.',
