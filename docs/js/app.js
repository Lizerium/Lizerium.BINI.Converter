(function () {
  ...
  const strings = {
    en: {
      ...
      'meta.description': 'Convert Freelancer (2003) BINI files to editable INI text and pack INI back to BINI in your browser. No upload, no backend, Windows-1251 support.',
      'nav.subtitle': 'Freelancer modding tool',
      'nav.converter': 'Converter',
      'nav.guide': 'Guide',
      'hero.eyebrow': 'Free browser tool',
      'hero.title': 'Convert Freelancer (2003) BINI files to editable INI text',
      'hero.lead': 'Open binary Freelancer (2003) configuration files, decode them to readable INI, edit the text, and pack it back to BINI without uploading files anywhere.',
      ...
      'demo.eyebrow': 'Live workflow',
      'demo.title': 'See the BINI conversion flow',
      'demo.text': 'The demo shows how a Freelancer (2003) BINI file becomes readable INI text in the browser, ready for inspection, editing, and repacking.',
      'demo.caption': 'Browser-only BINI to INI conversion demo.',
      ...
      'guide.open.text': 'BINI files are binary configuration files used by Freelancer (2003). Convert them to INI text before editing ship, market, equipment, or universe data.',
    ...
    ru: {
      ...
      'meta.description': 'Конвертируйте BINI файлы Freelancer (2003) в редактируемый INI и собирайте INI обратно в BINI прямо в браузере. Без загрузки файлов на сервер, с поддержкой Windows-1251.',
      'nav.subtitle': 'Инструмент для моддинга Freelancer',
      'nav.converter': 'Конвертер',
      'nav.guide': 'Гайд',
      'hero.eyebrow': 'Бесплатный инструмент в браузере',
      'hero.title': 'Конвертер BINI файлов Freelancer (2003) в редактируемый INI',
      'hero.lead': 'Открывайте бинарные конфиги Freelancer (2003), переводите их в читаемый INI, редактируйте текст и собирайте обратно в BINI без отправки файлов на сервер.',
      ...
      'demo.eyebrow': 'Рабочий процесс',
      'demo.title': 'Посмотрите процесс конвертации BINI',
      'demo.text': 'Демонстрация показывает, как BINI файл Freelancer (2003) становится читаемым INI прямо в браузере: его можно изучить, отредактировать и собрать обратно.',
      'demo.caption': 'Демонстрация конвертации BINI в INI прямо в браузере.',
      ...
      'guide.open.text': 'BINI - бинарные конфигурационные файлы Freelancer (2003). Перед редактированием данных кораблей, рынков, оборудования или вселенной их удобно перевести в текстовый INI.',
